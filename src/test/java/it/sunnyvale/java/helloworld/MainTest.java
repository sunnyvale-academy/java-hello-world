...
package it.sunnyvale.java.helloworld;
...
public class MainTest {
    ...
    public void testHelloWorld() throws Exception {
        webClient.get()
                ...
                //.thenAccept(jsonObject -> Assertions.assertThat("Hello World v\\.\\d\\.\\d from host .*! I'm running in .*!", jsonObject.getString("message")))
                .toCompletableFuture()
                .get();
